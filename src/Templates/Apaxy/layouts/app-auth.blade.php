...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('sources/css/app.css') }}">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center pb-4">
                        <img src="{{ asset('images/hw-instock.png') }}" height="50" alt="logo">
                        {{--  <h5 class="font-size-16 text-white-50 mb-4">InStock</h5>  --}}
                    </div>
                </div>
            </div>
